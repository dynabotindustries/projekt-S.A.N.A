#this file is the creation of Darshan Saravanan(github.com/dynaboindusties).
#the username and password are presently hardcoded though I plan on a cloud based one using firebase for the future(username:test;password:testing).
#the Innapropriate language detection is not yet implemented bt can be used with a cloud database(again firebase) and will be pretty usefull in educational and buisness environments.
    ...
    def onSend(self):
        ...
        if user_input:
            ...
            if any(phrase in user_input for phrase in ["who are you", "what are you", "who is this", "what is this", "who is sana", "what is sana"]):
                ...
                pyautogui.hotkey('ctrl', 'w')  # Simulate pressing Ctrl+W to close the active tab
                ...
                app_id = "PHP8VP-Y7P8Y25TTW"  # Replace with your own API key
